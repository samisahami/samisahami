...
### What I do
- Build SQL- and Python-driven analytics for business and Web3 use cases  
- Design Power BI dashboards focused on decision-making, not vanity metrics  
- Translate messy data into clear insights for non-technical stakeholders  
